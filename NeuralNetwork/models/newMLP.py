...
from NeuralNetwork.models.tf_siren.siren import SinusodialRepresentationDense
#from NeuralNetwork.models.tf_siren.siren_mlp import SIRENModel
    ...
    def net(self,
        ...
        with tf.variable_scope('MLP'):
            ...
            for layer in range(encoder_layer_num):
                ...
                in_node = tf.layers.dense(in_node, feature_num, activation=None)
                in_node = SinusodialRepresentationDense(256,
                                                  activation='sine',  # default activation function
                                                  w0=1.0)(in_node)  # w0 represents sin(w0 * x) where x is the input.
